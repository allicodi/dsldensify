...
Hurdle models combine a point-mass learner for \(P(A = 0 \mid W)\) with a positive-part density for \(A > 0\).
...
plot(
  ...
  mode = "conditional",
  component = "combined",
  main = "Hurdle model (point mass + density)"
)
plot(
  fit_hurdle,
  W_h_grid,
