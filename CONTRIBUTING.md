# Contributing to `dsldensify` development

We, the authors of the `dsldensify` R package, use the same guide as is used for
...
The goal of this guide is to help you get up and contributing to `dsldensify` as
...
To contribute a change to `dsldensify`, you follow these steps:
...
1.  __Motivation__. Your pull request should clearly and concisely motivates the
   ...
   `dsldensify` comes out it's easy for users to see what's changed. Add your
...
3.  __Use `dsldensify` coding style__. To do so, please follow the [official
    ...
    into the code. If you're modifying existing `dsldensify` code that doesn't
